...
void RXEvaluation::load() {
    ...
    //create tables
    std::ifstream from("/Users/caussebruno/Documents/developpement/Evaluation/weight_v1.bin", std::ios::binary);
    if(from) {
