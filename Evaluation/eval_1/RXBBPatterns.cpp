...
void RXBBPatterns::update_patterns_BLACK_A1(RXMove& move) const {
    ...
    unsigned long long flipped = move.flipped;
    ...
    /* direction _SE */
    switch(flipped & 0X0040201008040200ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0080808080808000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X7E00000000000000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_B1(RXMove& move) const {
    ...
    /* direction _SE */
    switch(flipped & 0X0020100804020000ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0040404040404000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X3E00000000000000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_C1(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0020202020202000ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0010080402000000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X1E00000000000000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_D1(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0010101010101000ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0008040200000000ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0020400000000000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X0E00000000000000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X6000000000000000ULL) {
        case 0X6000000000000000ULL:
            p.flip_BLACK_B1();
        case 0X2000000000000000ULL:
            p.flip_BLACK_C1();
...
void RXBBPatterns::update_patterns_BLACK_E1(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0008080808080800ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0004020000000000ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0010204000000000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X0600000000000000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X7000000000000000ULL) {
        case 0X7000000000000000ULL:
            p.flip_BLACK_B1();
        case 0X3000000000000000ULL:
            p.flip_BLACK_C1();
...
void RXBBPatterns::update_patterns_BLACK_F1(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0004040404040400ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0008102040000000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X7800000000000000ULL) {
        case 0X7800000000000000ULL:
            p.flip_BLACK_B1();
        case 0X3800000000000000ULL:
            p.flip_BLACK_C1();
...
void RXBBPatterns::update_patterns_BLACK_G1(RXMove& move) const {
    ...
    /* direction _SW */
    switch(flipped & 0X0004081020400000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X7C00000000000000ULL) {
        case 0X7C00000000000000ULL:
            p.flip_BLACK_B1();
        case 0X3C00000000000000ULL:
            p.flip_BLACK_C1();
    ...
    /* direction S_ */
    switch(flipped & 0X0002020202020200ULL) {
...
void RXBBPatterns::update_patterns_BLACK_H1(RXMove& move) const {
    ...
    /* direction _SW */
    switch(flipped & 0X0002040810204000ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0001010101010100ULL) {
...
void RXBBPatterns::update_patterns_BLACK_A2(RXMove& move) const {
    ...
    /* direction _SE */
    switch(flipped & 0X0000402010080400ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000808080808000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X007E000000000000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_B2(RXMove& move) const {
    ...
    /* direction _SE */
    switch(flipped & 0X0000201008040200ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000404040404000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X003E000000000000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_C2(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0000202020202000ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0000100804020000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X001E000000000000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_D2(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0000101010101000ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0000080402000000ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0000204000000000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X000E000000000000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0060000000000000ULL) {
        case 0X0060000000000000ULL:
            p.flip_BLACK_B2();
        case 0X0020000000000000ULL:
            p.flip_BLACK_C2();
...
void RXBBPatterns::update_patterns_BLACK_E2(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0000080808080800ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0000040200000000ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0000102040000000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X0006000000000000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0070000000000000ULL) {
        case 0X0070000000000000ULL:
            p.flip_BLACK_B2();
        case 0X0030000000000000ULL:
            p.flip_BLACK_C2();
...
void RXBBPatterns::update_patterns_BLACK_F2(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0000040404040400ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0000081020400000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0078000000000000ULL) {
        case 0X0078000000000000ULL:
            p.flip_BLACK_B2();
        case 0X0038000000000000ULL:
            p.flip_BLACK_C2();
...
void RXBBPatterns::update_patterns_BLACK_G2(RXMove& move) const {
    ...
    /* direction _SW */
    switch(flipped & 0X0000040810204000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X007C000000000000ULL) {
        case 0X007C000000000000ULL:
            p.flip_BLACK_B2();
        case 0X003C000000000000ULL:
            p.flip_BLACK_C2();
    ...
    /* direction S_ */
    switch(flipped & 0X0000020202020200ULL) {
...
void RXBBPatterns::update_patterns_BLACK_H2(RXMove& move) const {
    ...
    /* direction _SW */
    switch(flipped & 0X0000020408102000ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000010101010100ULL) {
...
void RXBBPatterns::update_patterns_BLACK_A3(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X00007E0000000000ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0000004020100800ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000008080808000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_B3(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X00003E0000000000ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0000002010080400ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000004040404000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_C3(RXMove& move) const {
    ...
    /* direction _SE */
    switch(flipped & 0X0000001008040200ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000002020202000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X00001E0000000000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_D3(RXMove& move) const {
    ...
    /* direction _SE */
    switch(flipped & 0X0000000804020000ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000001010101000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X00000E0000000000ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0000002040000000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0000600000000000ULL) {
        case 0X0000600000000000ULL:
            p.flip_BLACK_B3();
        case 0X0000200000000000ULL:
            p.flip_BLACK_C3();
...
void RXBBPatterns::update_patterns_BLACK_E3(RXMove& move) const {
    ...
    /* direction _SE */
    switch(flipped & 0X0000000402000000ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000808080800ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X0000060000000000ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0000001020400000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0000700000000000ULL) {
        case 0X0000700000000000ULL:
            p.flip_BLACK_B3();
        case 0X0000300000000000ULL:
            p.flip_BLACK_C3();
...
void RXBBPatterns::update_patterns_BLACK_F3(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000404040400ULL) {
    ...
    /* direction _SW */
    switch(flipped & 0X0000000810204000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0000780000000000ULL) {
        case 0X0000780000000000ULL:
            p.flip_BLACK_B3();
        case 0X0000380000000000ULL:
            p.flip_BLACK_C3();
...
void RXBBPatterns::update_patterns_BLACK_G3(RXMove& move) const {
    ...
    /* direction _W */
    switch(flipped & 0X00007C0000000000ULL) {
        case 0X00007C0000000000ULL:
            p.flip_BLACK_B3();
        case 0X00003C0000000000ULL:
            p.flip_BLACK_C3();
    ...
    /* direction _SW */
    switch(flipped & 0X0000000408102000ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000202020200ULL) {
...
void RXBBPatterns::update_patterns_BLACK_H3(RXMove& move) const {
    ...
    /* direction _SW */
    switch(flipped & 0X0000000204081000ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000101010100ULL) {
...
void RXBBPatterns::update_patterns_BLACK_A4(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X0000007E00000000ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0000000040201000ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0080800000000000ULL) {
        case 0X0080800000000000ULL:
            p.flip_BLACK_A2();
        case 0X0000800000000000ULL:
            p.flip_BLACK_A3();
    ...
    /* direction S_ */
    switch(flipped & 0X0000000080808000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_B4(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X0000003E00000000ULL) {
    ...
    /* direction NE */
    switch(flipped & 0X0010200000000000ULL) {
        case 0X0010200000000000ULL:
            p.flip_BLACK_D2();
        case 0X0000200000000000ULL:
            p.flip_BLACK_C3();
    ...
    /* direction _SE */
    switch(flipped & 0X0000000020100800ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0040400000000000ULL) {
        case 0X0040400000000000ULL:
            p.flip_BLACK_B2();
        case 0X0000400000000000ULL:
            p.flip_BLACK_B3();
    ...
    /* direction S_ */
    switch(flipped & 0X0000000040404000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_C4(RXMove& move) const {
    ...
    /* direction _SE */
    switch(flipped & 0X0000000010080400ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000020202000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X0000001E00000000ULL) {
    ...
    /* direction NE */
    switch(flipped & 0X0008100000000000ULL) {
        case 0X0008100000000000ULL:
            p.flip_BLACK_E2();
        case 0X0000100000000000ULL:
            p.flip_BLACK_D3();
    ...
    /* direction _N */
    switch(flipped & 0X0020200000000000ULL) {
        case 0X0020200000000000ULL:
            p.flip_BLACK_C2();
        case 0X0000200000000000ULL:
            p.flip_BLACK_C3();
...
void RXBBPatterns::update_patterns_BLACK_F4(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000004040400ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0004040000000000ULL) {
        case 0X0004040000000000ULL:
            p.flip_BLACK_F2();
        case 0X0000040000000000ULL:
            p.flip_BLACK_F3();
    ...
    /* direction NW */
    switch(flipped & 0X0010080000000000ULL) {
        case 0X0010080000000000ULL:
            p.flip_BLACK_D2();
        case 0X0000080000000000ULL:
            p.flip_BLACK_E3();
    ...
    /* direction _SW */
    switch(flipped & 0X0000000008102000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0000007800000000ULL) {
        case 0X0000007800000000ULL:
            p.flip_BLACK_B4();
        case 0X0000003800000000ULL:
            p.flip_BLACK_C4();
...
void RXBBPatterns::update_patterns_BLACK_G4(RXMove& move) const {
    ...
    /* direction _W */
    switch(flipped & 0X0000007C00000000ULL) {
        case 0X0000007C00000000ULL:
            p.flip_BLACK_B4();
        case 0X0000003C00000000ULL:
            p.flip_BLACK_C4();
    ...
    /* direction _SW */
    switch(flipped & 0X0000000004081000ULL) {
    ...
    /* direction NW */
    switch(flipped & 0X0008040000000000ULL) {
        case 0X0008040000000000ULL:
            p.flip_BLACK_E2();
        case 0X0000040000000000ULL:
            p.flip_BLACK_F3();
    ...
    /* direction S_ */
    switch(flipped & 0X0000000002020200ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0002020000000000ULL) {
        case 0X0002020000000000ULL:
            p.flip_BLACK_G2();
        case 0X0000020000000000ULL:
            p.flip_BLACK_G3();
...
void RXBBPatterns::update_patterns_BLACK_H4(RXMove& move) const {
    ...
    /* direction _SW */
    switch(flipped & 0X0000000002040800ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000001010100ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0001010000000000ULL) {
        case 0X0001010000000000ULL:
            p.flip_BLACK_H2();
        case 0X0000010000000000ULL:
            p.flip_BLACK_H3();
...
void RXBBPatterns::update_patterns_BLACK_A5(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X000000007E000000ULL) {
    ...
    /* direction _SE */
    switch(flipped & 0X0000000000402000ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0080808000000000ULL) {
        case 0X0080808000000000ULL:
            p.flip_BLACK_A2();
        case 0X0000808000000000ULL:
            p.flip_BLACK_A3();
    ...
    /* direction S_ */
    switch(flipped & 0X0000000000808000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_B5(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X000000003E000000ULL) {
    ...
    /* direction NE */
    switch(flipped & 0X0008102000000000ULL) {
        case 0X0008102000000000ULL:
            p.flip_BLACK_E2();
        case 0X0000102000000000ULL:
            p.flip_BLACK_D3();
    ...
    /* direction _SE */
    switch(flipped & 0X0000000000201000ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0040404000000000ULL) {
        case 0X0040404000000000ULL:
            p.flip_BLACK_B2();
        case 0X0000404000000000ULL:
            p.flip_BLACK_B3();
    ...
    /* direction S_ */
    switch(flipped & 0X0000000000404000ULL) {
...
void RXBBPatterns::update_patterns_BLACK_C5(RXMove& move) const {
    ...
    /* direction _SE */
    switch(flipped & 0X0000000000100800ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000000202000ULL) {
    ...
    /* direction _E */
    switch(flipped & 0X000000001E000000ULL) {
    ...
    /* direction NE */
    switch(flipped & 0X0004081000000000ULL) {
        case 0X0004081000000000ULL:
            p.flip_BLACK_F2();
        case 0X0000081000000000ULL:
            p.flip_BLACK_E3();
    ...
    /* direction _N */
    switch(flipped & 0X0020202000000000ULL) {
        case 0X0020202000000000ULL:
            p.flip_BLACK_C2();
        case 0X0000202000000000ULL:
            p.flip_BLACK_C3();
...
void RXBBPatterns::update_patterns_BLACK_F5(RXMove& move) const {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000000040400ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0004040400000000ULL) {
        case 0X0004040400000000ULL:
            p.flip_BLACK_F2();
        case 0X0000040400000000ULL:
            p.flip_BLACK_F3();
    ...
    /* direction NW */
    switch(flipped & 0X0020100800000000ULL) {
        case 0X0020100800000000ULL:
            p.flip_BLACK_C2();
        case 0X0000100800000000ULL:
            p.flip_BLACK_D3();
    ...
    /* direction _SW */
    switch(flipped & 0X0000000000081000ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0000000078000000ULL) {
        case 0X0000000078000000ULL:
            p.flip_BLACK_B5();
        case 0X0000000038000000ULL:
            p.flip_BLACK_C5();
...
void RXBBPatterns::update_patterns_BLACK_G5(RXMove& move) const {
    ...
    /* direction _W */
    switch(flipped & 0X000000007C000000ULL) {
        case 0X000000007C000000ULL:
            p.flip_BLACK_B5();
        case 0X000000003C000000ULL:
            p.flip_BLACK_C5();
    ...
    /* direction _SW */
    switch(flipped & 0X0000000000040800ULL) {
    ...
    /* direction NW */
    switch(flipped & 0X0010080400000000ULL) {
        case 0X0010080400000000ULL:
            p.flip_BLACK_D2();
        case 0X0000080400000000ULL:
            p.flip_BLACK_E3();
    ...
    /* direction S_ */
    switch(flipped & 0X0000000000020200ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0002020200000000ULL) {
        case 0X0002020200000000ULL:
            p.flip_BLACK_G2();
        case 0X0000020200000000ULL:
            p.flip_BLACK_G3();
...
void RXBBPatterns::update_patterns_BLACK_H5(RXMove& move) const {
    ...
    /* direction _SW */
    switch(flipped & 0X0000000000020400ULL) {
    ...
    /* direction S_ */
    switch(flipped & 0X0000000000010100ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0001010100000000ULL) {
        case 0X0001010100000000ULL:
            p.flip_BLACK_H2();
        case 0X0000010100000000ULL:
            p.flip_BLACK_H3();
...
void RXBBPatterns::update_patterns_BLACK_A6(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X00000000007E0000ULL) {
    ...
    /* direction _N */
    switch(flipped & 0X0080808080000000ULL) {
        case 0X0080808080000000ULL:
            p.flip_BLACK_A2();
        case 0X0000808080000000ULL:
            p.flip_BLACK_A3();
...
void RXBBPatterns::update_patterns_BLACK_B6(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X00000000003E0000ULL) {
    ...
    /* direction NE */
    switch(flipped & 0X0004081020000000ULL) {
        case 0X0004081020000000ULL:
            p.flip_BLACK_F2();
        case 0X0000081020000000ULL:
            p.flip_BLACK_E3();
    ...
    /* direction _N */
    switch(flipped & 0X0040404040000000ULL) {
        case 0X0040404040000000ULL:
            p.flip_BLACK_B2();
        case 0X0000404040000000ULL:
            p.flip_BLACK_B3();
...
void RXBBPatterns::update_patterns_BLACK_C6(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X00000000001E0000ULL) {
    ...
    /* direction NE */
    switch(flipped & 0X0002040810000000ULL) {
        case 0X0002040810000000ULL:
            p.flip_BLACK_G2();
        case 0X0000040810000000ULL:
            p.flip_BLACK_F3();
    ...
    /* direction _N */
    switch(flipped & 0X0020202020000000ULL) {
        case 0X0020202020000000ULL:
            p.flip_BLACK_C2();
        case 0X0000202020000000ULL:
            p.flip_BLACK_C3();
...
void RXBBPatterns::update_patterns_BLACK_D6(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X00000000000E0000ULL) {
    ...
    /* direction NE */
    switch(flipped & 0X0000020408000000ULL) {
        case 0X0000020408000000ULL:
            p.flip_BLACK_G3();
        case 0X0000000408000000ULL:
            p.flip_BLACK_F4();
    ...
    /* direction _N */
    switch(flipped & 0X0010101010000000ULL) {
        case 0X0010101010000000ULL:
            p.flip_BLACK_D2();
        case 0X0000101010000000ULL:
            p.flip_BLACK_D3();
    ...
    /* direction NW */
    switch(flipped & 0X0000004020000000ULL) {
        case 0X0000004020000000ULL:
            p.flip_BLACK_B4();
        case 0X0000000020000000ULL:
            p.flip_BLACK_C5();
    ...
    /* direction _W */
    switch(flipped & 0X0000000000600000ULL) {
        case 0X0000000000600000ULL:
            p.flip_BLACK_B6();
        case 0X0000000000200000ULL:
            p.flip_BLACK_C6();
...
void RXBBPatterns::update_patterns_BLACK_E6(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X0000000000060000ULL) {
    ...
    /* direction NE */
    switch(flipped & 0X0000000204000000ULL) {
        case 0X0000000204000000ULL:
            p.flip_BLACK_G4();
        case 0X0000000004000000ULL:
            p.flip_BLACK_F5();
    ...
    /* direction _N */
    switch(flipped & 0X0008080808000000ULL) {
        case 0X0008080808000000ULL:
            p.flip_BLACK_E2();
        case 0X0000080808000000ULL:
            p.flip_BLACK_E3();
    ...
    /* direction NW */
    switch(flipped & 0X0000402010000000ULL) {
        case 0X0000402010000000ULL:
            p.flip_BLACK_B3();
        case 0X0000002010000000ULL:
            p.flip_BLACK_C4();
    ...
    /* direction _W */
    switch(flipped & 0X0000000000700000ULL) {
        case 0X0000000000700000ULL:
            p.flip_BLACK_B6();
        case 0X0000000000300000ULL:
            p.flip_BLACK_C6();
...
void RXBBPatterns::update_patterns_BLACK_F6(RXMove& move) const {
    ...
    /* direction _N */
    switch(flipped & 0X0004040404000000ULL) {
        case 0X0004040404000000ULL:
            p.flip_BLACK_F2();
        case 0X0000040404000000ULL:
            p.flip_BLACK_F3();
    ...
    /* direction NW */
    switch(flipped & 0X0040201008000000ULL) {
        case 0X0040201008000000ULL:
            p.flip_BLACK_B2();
        case 0X0000201008000000ULL:
            p.flip_BLACK_C3();
    ...
    /* direction _W */
    switch(flipped & 0X0000000000780000ULL) {
        case 0X0000000000780000ULL:
            p.flip_BLACK_B6();
        case 0X0000000000380000ULL:
            p.flip_BLACK_C6();
...
void RXBBPatterns::update_patterns_BLACK_G6(RXMove& move) const {
    ...
    /* direction _W */
    switch(flipped & 0X00000000007C0000ULL) {
        case 0X00000000007C0000ULL:
            p.flip_BLACK_B6();
        case 0X00000000003C0000ULL:
            p.flip_BLACK_C6();
    ...
    /* direction NW */
    switch(flipped & 0X0020100804000000ULL) {
        case 0X0020100804000000ULL:
            p.flip_BLACK_C2();
        case 0X0000100804000000ULL:
            p.flip_BLACK_D3();
    ...
    /* direction _N */
    switch(flipped & 0X0002020202000000ULL) {
        case 0X0002020202000000ULL:
            p.flip_BLACK_G2();
        case 0X0000020202000000ULL:
            p.flip_BLACK_G3();
...
void RXBBPatterns::update_patterns_BLACK_H6(RXMove& move) const {
    ...
    /* direction _N */
    switch(flipped & 0X0001010101000000ULL) {
        case 0X0001010101000000ULL:
            p.flip_BLACK_H2();
        case 0X0000010101000000ULL:
            p.flip_BLACK_H3();
...
void RXBBPatterns::update_patterns_BLACK_A7(RXMove& move) const {
    ...
    /* direction _N */
    switch(flipped & 0X0080808080800000ULL) {
        case 0X0080808080800000ULL:
            p.flip_BLACK_A2();
        case 0X0000808080800000ULL:
            p.flip_BLACK_A3();
    ...
    /* direction _E */
    switch(flipped & 0X0000000000007E00ULL) {
...
void RXBBPatterns::update_patterns_BLACK_B7(RXMove& move) const {
    ...
    /* direction NE */
    switch(flipped & 0X0002040810200000ULL) {
        case 0X0002040810200000ULL:
            p.flip_BLACK_G2();
        case 0X0000040810200000ULL:
            p.flip_BLACK_F3();
    ...
    /* direction _N */
    switch(flipped & 0X0040404040400000ULL) {
        case 0X0040404040400000ULL:
            p.flip_BLACK_B2();
        case 0X0000404040400000ULL:
            p.flip_BLACK_B3();
    ...
    /* direction _E */
    switch(flipped & 0X0000000000003E00ULL) {
...
void RXBBPatterns::update_patterns_BLACK_C7(RXMove& move) const {
    ...
    /* direction _N */
    switch(flipped & 0X0020202020200000ULL) {
        case 0X0020202020200000ULL:
            p.flip_BLACK_C2();
        case 0X0000202020200000ULL:
            p.flip_BLACK_C3();
    ...
    /* direction NE */
    switch(flipped & 0X0000020408100000ULL) {
        case 0X0000020408100000ULL:
            p.flip_BLACK_G3();
        case 0X0000000408100000ULL:
            p.flip_BLACK_F4();
    ...
    /* direction _E */
    switch(flipped & 0X0000000000001E00ULL) {
...
void RXBBPatterns::update_patterns_BLACK_D7(RXMove& move) const {
    ...
    /* direction _N */
    switch(flipped & 0X0010101010100000ULL) {
        case 0X0010101010100000ULL:
            p.flip_BLACK_D2();
        case 0X0000101010100000ULL:
            p.flip_BLACK_D3();
    ...
    /* direction NE */
    switch(flipped & 0X0000000204080000ULL) {
        case 0X0000000204080000ULL:
            p.flip_BLACK_G4();
        case 0X0000000004080000ULL:
            p.flip_BLACK_F5();
    ...
    /* direction NW */
    switch(flipped & 0X0000000040200000ULL) {
        case 0X0000000040200000ULL:
            p.flip_BLACK_B5();
        case 0X0000000000200000ULL:
            p.flip_BLACK_C6();
    ...
    /* direction _E */
    switch(flipped & 0X0000000000000E00ULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0000000000006000ULL) {
        case 0X0000000000006000ULL:
            p.flip_BLACK_B7();
        case 0X0000000000002000ULL:
            p.flip_BLACK_C7();
...
void RXBBPatterns::update_patterns_BLACK_E7(RXMove& move) const {
    ...
    /* direction _N */
    switch(flipped & 0X0008080808080000ULL) {
        case 0X0008080808080000ULL:
            p.flip_BLACK_E2();
        case 0X0000080808080000ULL:
            p.flip_BLACK_E3();
    ...
    /* direction NE */
    switch(flipped & 0X0000000002040000ULL) {
        case 0X0000000002040000ULL:
            p.flip_BLACK_G5();
        case 0X0000000000040000ULL:
            p.flip_BLACK_F6();
    ...
    /* direction NW */
    switch(flipped & 0X0000004020100000ULL) {
        case 0X0000004020100000ULL:
            p.flip_BLACK_B4();
        case 0X0000000020100000ULL:
            p.flip_BLACK_C5();
    ...
    /* direction _E */
    switch(flipped & 0X0000000000000600ULL) {
        case 0X0000000000000600ULL:
            p.flip_BLACK_G7();
        case 0X0000000000000400ULL:
            p.flip_BLACK_F7();
    }


    /* direction _W */
    switch(flipped & 0X0000000000007000ULL) {
        case 0X0000000000007000ULL:
            p.flip_BLACK_B7();
        case 0X0000000000003000ULL:
            p.flip_BLACK_C7();
...
void RXBBPatterns::update_patterns_BLACK_F7(RXMove& move) const {
    ...
    /* direction _N */
    switch(flipped & 0X0004040404040000ULL) {
        case 0X0004040404040000ULL:
            p.flip_BLACK_F2();
        case 0X0000040404040000ULL:
            p.flip_BLACK_F3();
    ...
    /* direction NW */
    switch(flipped & 0X0000402010080000ULL) {
        case 0X0000402010080000ULL:
            p.flip_BLACK_B3();
        case 0X0000002010080000ULL:
            p.flip_BLACK_C4();
    ...
    /* direction _W */
    switch(flipped & 0X0000000000007800ULL) {
        case 0X0000000000007800ULL:
            p.flip_BLACK_B7();
        case 0X0000000000003800ULL:
            p.flip_BLACK_C7();
...
void RXBBPatterns::update_patterns_BLACK_G7(RXMove& move) const {
    ...
    /* direction NW */
    switch(flipped & 0X0040201008040000ULL) {
        case 0X0040201008040000ULL:
            p.flip_BLACK_B2();
        case 0X0000201008040000ULL:
            p.flip_BLACK_C3();
    ...
    /* direction _N */
    switch(flipped & 0X0002020202020000ULL) {
        case 0X0002020202020000ULL:
            p.flip_BLACK_G2();
        case 0X0000020202020000ULL:
            p.flip_BLACK_G3();
    ...
    /* direction _W */
    switch(flipped & 0X0000000000007C00ULL) {
        case 0X0000000000007C00ULL:
            p.flip_BLACK_B7();
        case 0X0000000000003C00ULL:
            p.flip_BLACK_C7();
...
void RXBBPatterns::update_patterns_BLACK_H7(RXMove& move) const {
    ...
    /* direction _N */
    switch(flipped & 0X0001010101010000ULL) {
        case 0X0001010101010000ULL:
            p.flip_BLACK_H2();
        case 0X0000010101010000ULL:
            p.flip_BLACK_H3();
...
void RXBBPatterns::update_patterns_BLACK_A8(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X000000000000007EULL) {
...
void RXBBPatterns::update_patterns_BLACK_B8(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X000000000000003EULL) {
...
void RXBBPatterns::update_patterns_BLACK_C8(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X000000000000001EULL) {
...
void RXBBPatterns::update_patterns_BLACK_D8(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X000000000000000EULL) {
    ...
    /* direction _W */
    switch(flipped & 0X0000000000000060ULL) {
        case 0X0000000000000060ULL:
            p.flip_BLACK_B8();
        case 0X0000000000000020ULL:
            p.flip_BLACK_C8();
...
void RXBBPatterns::update_patterns_BLACK_E8(RXMove& move) const {
    ...
    /* direction _E */
    switch(flipped & 0X0000000000000006ULL) {
        case 0X0000000000000006ULL:
            p.flip_BLACK_G8();
        case 0X0000000000000004ULL:
            p.flip_BLACK_F8();
    }


    /* direction _W */
    switch(flipped & 0X0000000000000070ULL) {
        case 0X0000000000000070ULL:
            p.flip_BLACK_B8();
        case 0X0000000000000030ULL:
            p.flip_BLACK_C8();
...
void RXBBPatterns::update_patterns_BLACK_F8(RXMove& move) const {
    ...
    /* direction _W */
    switch(flipped & 0X0000000000000078ULL) {
        case 0X0000000000000078ULL:
            p.flip_BLACK_B8();
        case 0X0000000000000038ULL:
            p.flip_BLACK_C8();
...
void RXBBPatterns::update_patterns_BLACK_G8(RXMove& move) const {
    ...
    /* direction _W */
    switch(flipped & 0X000000000000007CULL) {
        case 0X000000000000007CULL:
            p.flip_BLACK_B8();
        case 0X000000000000003CULL:
            p.flip_BLACK_C8();
