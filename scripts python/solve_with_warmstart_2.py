...
'''
# n'a plus de sens avec A_reduite

# l'idee serait de conserver les poids de x0 absents de x
# en dininuant leurs valeurs par exemple : *0,9
# le poids chuterait lentement plutot que la mise a 0
...
if x0 is not None:
    ...
    poids_inchanges = (np.abs(x - x0) < TOLERANCE_UNCHANGED)
